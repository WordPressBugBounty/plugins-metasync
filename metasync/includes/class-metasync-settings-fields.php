                    ...
                    <div>
                        ...
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <input type="number" 
                                   ...
                                   <?php if ($memory_range['max'] !== null): ?>max="<?php echo esc_attr($memory_range['max']); ?>"<?php endif; ?>
                        ...
                        <p style="color: var(--dashboard-text-secondary); font-size: 12px; margin: 4px 0 0 0;">
                            Server Limit: <?php echo esc_html($server_limits['memory_limit']); ?> &middot; Allowed: <?php echo $memory_range['max'] !== null ? esc_html($memory_range['min'] . '–' . $memory_range['max'] . ' MB') : esc_html($memory_range['min'] . ' MB or higher'); ?>
                        </p>
                        <?php if (!$server_limits['can_change_memory']): ?>
