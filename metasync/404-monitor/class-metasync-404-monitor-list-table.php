...
class Metasync_Error_Monitor_List_Table extends WP_List_Table
{
	...
	protected function process_bulk_action()
	{
		...
		// Suppress every submit that did not come from Apply. Search and the
		// filter controls share this form with the bulk dropdown, the ticked rows
		// and the nonce, so without this the selected action - including the
		// irreversible Empty Table - ran on any of those submits.
